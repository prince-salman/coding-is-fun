    ...
    modules: [
      {
        ...
        successMessage: "Kerja bagus, {{playerName}}! Tag <h1> adalah tag heading terbesar, sangat penting untuk judul utama halaman web dan juga untuk SEO."
      },
      {
        id: "1.2",
        type: "materi",
        ...
        successMessage: "Sip! Sekarang halamannya mulai terlihat berisi. Konsep membuka dan menutup tag seperti <p>... </p> adalah hal yang akan selalu kamu gunakan."
      },
      {
        id: "1.3",
        type: "materi",
        ...
        validator: (code) => /<strong>.+<\/strong>/i.test(code) && /<em>.+<\/em>/i.test(code),
        successMessage: "Sempurna! Teksnya kini jauh lebih dinamis. Tag <strong> dan <em> disebut tag 'inline', artinya mereka tidak membuat baris baru."
      },
      {
        id: "1-exam",
        type: "ujian",
        ...
        successMessage: "Hebat! Kamu telah menguasai struktur teks dasar HTML. Siap untuk materi yang lebih menantang?"
      }
    ]
  },
  {
    ...
    modules: [
      {
        ...
        validator: (code) => /<a\s+[^>]*href\s*=\s*['"][^'"]*['"][^>]*>.+<\/a>/i.test(code),
        successMessage: "Tautan berhasil dibuat! Atribut href adalah fondasi dari seluruh navigasi internet."
      },
      {
        id: "2-exam",
        type: "ujian",
        ...
        validator: (code) => {
          const matches = code.match(/<a\s+[^>]*href\s*=\s*['"][^'"]*['"][^>]*>.*?<\/a>/gi);
    ...
    modules: [
      {
        ...
        validator: (code) => /<img\s+[^>]*src\s*=\s*['"][^'"]*['"][^>]*>/i.test(code),
        successMessage: "Benar sekali! Ingat, atribut alt sangat penting untuk aksesibilitas (membantu tunanetra yang menggunakan screen reader)."
      },
      {
        id: "3-exam",
        type: "ujian",
        ...
        successMessage: "Sempurna! Kamu baru saja memahami konsep 'Nesting' (menyarangkan tag di dalam tag lain)."
      }
    ]
  },
  {
    ...
    modules: [
      {
        ...
        successMessage: "Kerja bagus. Struktur daftar sangat sering digunakan dalam pembuatan navigasi web profesional (Navbar)."
      }
    ]
  },
  {
    ...
    modules: [
      {
        ...
        successMessage: "LUAR BIASA! Kode kamu sangat bersih dan terstruktur. Selamat, {{playerName}}, kamu kini resmi menyandang predikat Junior Frontend Developer! Masa depanmu sangat cerah."
      }
    ]
  }
];
